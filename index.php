...
<body>
    ...
    <div id="main-content" class="container">
        ...
        <h3 id="menu-categories-title" class="text-center">Все отзывы взяты с нашей <a
                href="https://vk.com/pojiloybeavis" class="group-ref">официальной группы вконтакте</a></h3>

        <section class="row">
            <div class="menu-item-tile col-md-6">
                <div class="row">
                    <div class="review-item">
                        <div>Делала маникюр у Татьяны, сегодня у Ники все очень понравилось, предельно аккуратно,
                            чисто,красиво!!!!Девочки просто молодцы!!!! Большая палитра оттенков. Спасибо приду еще!!!!
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <section id="testimonials" class="col-sm-4">
                    ...
                    <a href="gallery.html">
                        <div class="footer-nav">Галерея</div>
                    </a>
                    <a href="#menu-categories-title">
                        <div class="footer-nav">Услуги</div>
                    </a>
                    <a href="#testimonials">
                        <div class="footer-nav">Обучение</div>
                    </a>
                    <a href="#testimonials">
                        <div class="footer-nav">Вакансии</div>
                    </a>
                    <a href="#review">
                        <div class="footer-nav">Отзывы</div>
                    </a>
                </section>
            </div>
